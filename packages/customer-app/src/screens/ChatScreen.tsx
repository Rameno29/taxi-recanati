...
import { colors as staticColors, spacing, radii } from "../theme";
...
export default function ChatScreen({ route }: Props) {
  ...
  useEffect(() => {
    ...
    if (socket) {
      // Ensure we're in the ride room so chat:message broadcasts reach us
...
const styles = StyleSheet.create({
  ...
  emptyText: { color: staticColors.bodyText, fontSize: 16 },
  bubble: {
    maxWidth: "80%",
    padding: spacing.md,
  ...
  bubbleText: { fontSize: 16, color: staticColors.dark },
